...
def connect(DB_TYPE: str = None):
    ...
    try:
        ...
        conn = mysql.connector.connect(user=Global.MARIA_DB_USER, password=Global.MARIA_DB_PASS, host=Global.MARIA_DB_IP, port=Global.MARIA_DB_PORT, database=Global.MARIA_DB_NAME, charset='utf8')
        curs = conn.cursor()
...
def getDataFrame(sql: str = None, args: dict = None, OP_TYPE: str = None):
    ...
    try:
        ...
        retVal = pandas.read_sqlsql(sql=sql, con=connector, params=args)
